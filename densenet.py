...
def conv_factory(x, nb_filter, dropout_rate=None, weight_decay=1E-4):
    ...
    :returns: keras network with b_norm, elu and convolution2d added
    :rtype: keras network
    """
...
def transition(x, nb_filter, dropout_rate=None, weight_decay=1E-4):
    ...
    :returns: model
    :rtype: keras model, after applying batch_norm, elu-conv, dropout, maxpool
